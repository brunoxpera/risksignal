...
//   - the Vulnerability, Evidence, Match and RiskSignal aggregates of ch. 6.1,
//     shaped to the ARCH-001 §1 data model: string UUID identities, no
//     timestamps. created_at/observed_at/occurred_at belong to the application
//     layer behind the injectable clock port (internal/platform/clock), never
//     to the domain;
